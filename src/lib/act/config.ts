// Auto-generated shim — re-exports from @/lib/topcit/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _topcit_Config } from "@/lib/topcit/config";
import { EXAM_CONFIG as _raw } from "@/lib/topcit/config";
