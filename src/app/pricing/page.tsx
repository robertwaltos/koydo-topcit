...
export const metadata: Metadata = {
  title: "Pricing — Topcit Premium",
  description: "Unlock unlimited Topcit practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=topcit&cadence=annual`;
