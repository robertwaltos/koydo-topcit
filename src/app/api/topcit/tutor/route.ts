...
const EXAM_ID = "topcit";
const EXAM_DISPLAY_NAME = "TOPCIT (Computational Thinking and Coding Evaluation)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. 한국어로 답변해주세요.

TOPCIT의 모든 영역을 다룹니다: 소프트웨어개발, 데이터, ICT비즈니스, 기술시스템. 컴퓨팅 사고력과 실무 역량을 함께 강화합니다.
